...
import { Form, Button, Checkbox, message, Input, Icon, Upload } from "antd";
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        formData.set(
          "image",
          values.image ? values.image[0].originFileObj : undefined
        );
  ...
  render() {
    ...
    return (
      <div className="main-content donate-page">
        ...
        <hr className="divide" />
        <Form onSubmit={this.handleSubmit} className="donate">
          ...
          <Form.Item name="city" rules={[{ required: true }]}>
            {getFieldDecorator("city", {
              rules: [{ required: true }],
            })(<Input placeholder="City" disabled={this.state.disabled} />)}
          </Form.Item>
          ...
          <div className="name">
            <Form.Item name="state" rules={[{ required: true }]}>
              {getFieldDecorator("state", {
                rules: [{ required: true }],
              })(<Input placeholder="State" disabled={this.state.disabled} />)}
            </Form.Item>
            ...
            <Form.Item name="postalCode" rules={[{ required: true }]}>
              {getFieldDecorator("postalCode", {
                ...
                <Input placeholder="Zip Code" disabled={this.state.disabled} />
              )}
            </Form.Item>
          </div>
          ...
          <Form.Item
            ...
            className="check-box"
          >
            <Checkbox onChange={this.onCheck}>Use Default Address</Checkbox>
          </Form.Item>
